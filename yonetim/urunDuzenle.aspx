<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/yonetim.master" AutoEventWireup="true" CodeFile="urunDuzenle.aspx.cs" Inherits="yonetim_urunDuzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderYonetim" Runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            <td>Ürün Foto</td>
            <td>
                <asp:ImageButton ID="ImageUrunler" runat="server" />
                <br />
