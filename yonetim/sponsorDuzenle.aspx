<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/yonetim.master" AutoEventWireup="true" CodeFile="sponsorDuzenle.aspx.cs" Inherits="yonetim_sponsorDuzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderYonetim" Runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            <td>Sponsor Foto</td>
            <td>
                <asp:ImageButton ID="ImageSponsor" runat="server" />
                <br />
        ...
        <tr>
            <td>Sponsor Metin</td>
            <td>
                <asp:TextBox ID="txtMetin" runat="server" Width="95%"></asp:TextBox><br />
            </td>
        </tr>
        <tr>
            <td>Sponsor Hedef</td>
            <td>
                <asp:TextBox ID="txtHedef" runat="server" Width="95%"></asp:TextBox><br />
            </td>
        </tr>
        <tr>
